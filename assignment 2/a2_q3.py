    ...
    for t in range(5):
        ...
        for i in range(max_domain):
            ...
            for j in range(max_domain):
                ...
                AC3(mycsp)
                assignment=backtracking_search(mycsp,mrv,lcv,mac)
                total_nassigns+=mycsp.nassigns
                total_nunassigns+=mycsp.nunassigns
                if assignment!=None:
                    break
        ...
        print('total number of assigned ',total_nassigns)
        print('total number of unassigned ',total_nunassigns)
